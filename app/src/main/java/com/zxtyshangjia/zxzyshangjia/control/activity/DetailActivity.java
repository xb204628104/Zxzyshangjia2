    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dpPicker.init(year, monthOfYear, dayOfMonth, new DatePicker.OnDateChangedListener() {
            ...
            public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                DetailActivity.this.monthOfYear = monthOfYear;
        ...
        detail_tv_shuaxin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Toast.makeText(DetailActivity.this, "执行了", Toast.LENGTH_SHORT).show();
                Dialog dialog=new AlertDialog.Builder(DetailActivity.this)
                        .setSingleChoiceItems(item, -1, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                switch (item[which]){
                                    case "全部":
                                        Toast.makeText(DetailActivity.this, "全部", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "转账":
                                        Toast.makeText(DetailActivity.this, "转账", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "收益":
                                        Toast.makeText(DetailActivity.this, "收益", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "消费":
                                        Toast.makeText(DetailActivity.this, "消费", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "兑换":
                                        Toast.makeText(DetailActivity.this, "兑换", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "提现":
                                        Toast.makeText(DetailActivity.this, "提现", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "退款":
                                        Toast.makeText(DetailActivity.this, "退款", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                    case "抽奖":
                                        Toast.makeText(DetailActivity.this, "22", Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                        break;
                                }
